...
public interface PostRepository extends JpaRepository<Post, Integer> {
    @Query(value = "SELECT new backendgrabstudent.backend_GrabStudent.DTO.PostDTO(p.id, s.id, p.pickUpLocation, p.dropOffLocation,p.status, p.type, " +
    ...
    List<PostDTO> findByType(String type);
}
